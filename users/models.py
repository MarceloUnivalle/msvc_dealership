...
class UserManager(BaseUserManager):
    def create_user(self, email, name, last_name, cedula, password, city=None):
        ...
        from dealership.models import City
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    city = models.ForeignKey(
        "dealership.City", on_delete=models.CASCADE, null=True, blank=True
    )
    ...
    def has_city_object(self):
        ...
        except "dealership.City".DoesNotExist:
            pass
        return has_city
...
class StaffMember(models.Model):
    ...
    office = models.ForeignKey(
        "dealership.Office", on_delete=models.CASCADE, default=None
    )
    name = models.CharField(max_length=60)
    last_name = models.CharField(max_length=60)
    email = models.CharField(max_length=100)
    ...
    company_position = models.ForeignKey(
        "dealership.CompanyPosition", on_delete=models.CASCADE, default=None
    )
